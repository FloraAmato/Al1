...
namespace CreaProject.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShareOfEntitlement = table.Column<decimal>(
                        type: "decimal(3, 2)",
                        nullable: false
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "AgentUtilities");
            ...
            migrationBuilder.DropTable(name: "RestrictedAssignments");

            migrationBuilder.DropTable(name: "AspNetRoles");

            migrationBuilder.DropTable(name: "Agents");

            migrationBuilder.DropTable(name: "Goods");
